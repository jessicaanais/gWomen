  ...
  return knex('events').del()
    .then(function () {
      ...
      return knex('events').insert([
        ...
        {title: "HealthTech Women NYC: Kick of the New Year Happy Hour!", eventlink:"https://www.eventbrite.com/e/healthtech-women-nyc-kick-of-the-new-year-happy-hour-tickets-42102912946?aff=es2", date:"Febuary 8, 2018", city:"Scottsdale", state:"Arizona", host:"Girls in Tech: Phoenix"},
        {title: "Girls in Tech Phoenix Origin Series: Fireside Chat", eventlink:"https://www.eventbrite.com/e/girls-in-tech-phoenix-origin-series-fireside-chat-tickets-41497423912", date:"Febuary 8, 2018", city:"New York", state:"New York", host:"HealthTech Women"},
        {title: "Black Tech Women NYC - Wine & #Wins: 2018 Vision Board Workshop", eventlink:"https://www.eventbrite.com/e/black-tech-women-nyc-wine-wins-2018-vision-board-workshop-tickets-42031532445?aff=es2", date:"Febuary 8, 2018", city:"New York", state:"New York", host:"Black Tech Women"},
        ...
        {title: "Winning Women: Investing in Cryptocurrency & Blockchain Technologies", eventlink:"https://www.eventbrite.com/e/winning-women-investing-in-cryptocurrency-blockchain-technologies-tickets-41262341775?aff=es2", date:"Febuary 20, 2018", city:"New York", state:"New York", host:"NYWSE"},
        ...
        {title: "#BusinessGirlMagic Brunch & Learn NYC with Yasmin J. Mattox", eventlink:"https://www.eventbrite.com/e/businessgirlmagic-brunch-learn-nyc-with-yasmin-j-mattox-tickets-39990156635?aff=es2", date:"March 10, 2018", city:"New York", state:"New York", host:"#100BusinessGirls"},
