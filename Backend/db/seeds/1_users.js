  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        {firstname: "Jessica", lastname: "Duarte", username: "knownasjess", password: "jessica", photo:"https://media-exp2.licdn.com/mpr/mpr/shrinknp_400_400/AAIA_wDGAAAAAQAAAAAAAAuMAAAAJDhmMTcwNTA5LTMxMWMtNDcwZC1iNGYxLTY0ZDAxOTg0ZjhiZg.jpg", about: "Currently completing the web immersive program.", cohort:"66", state:"Arizona", linkedin:"https://www.linkedin.com/in/jessicaanais/", github:"https://github.com/jessicaanais"},
